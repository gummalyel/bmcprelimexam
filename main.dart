...
class MyAppState extends State<MyApp> {
  ...
  void convert(double value, String from, String to) { // Ayaw pong gumana sir sa akin. Kaya nilagyan ko na lang po ng "!" since ang goal po ay para sure na yung value pong makukuha sa map ay hindi null.
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (_startMeasure == null || _convertedMeasure == null || _numberFrom == 0) {
                      return; // Note: Sir, ayaw po gumana nung ".isEmpty". Kaya "== null" na lang po ginamit ko po.
                    } 
                    else {
